...
int main(int argc, char *argv[]) {
  ...
  int opt;
  while ((opt = getopt(argc, argv, "r:c:x:y:f:s:C:")) != -1) {
    switch (opt) {
...
//	  y = y_orig;
  //}
  //if (line_empty)
  rgb_matrix::DrawText(canvas, font, x+1, y + 10, color, "Score");
  y += 10;
  rgb_matrix::DrawText(canvas, font, x+1, y + font.baseline() + 10, color, line);
